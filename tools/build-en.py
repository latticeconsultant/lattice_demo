...
THAY_THEM = [
    # Sơ đồ 07 (vòng khép kín tài chính) là ảnh có chữ — bản Anh dùng ảnh riêng.
    ('<img src="assets/img/lattice-so-cai-vi-v2.jpg" alt="Sơ đồ vòng khép kín tài chính quanh một sổ cái cho cả AI lẫn người: 1 Thu — doanh thu vào ví doanh nghiệp; 2 Phân bổ tự động — hợp đồng thông minh chia quỹ; 3 Chi trong hạn mức — agent chi theo chính sách; 4 Cửa phê duyệt — người ký khoản vượt ngưỡng; 5 Ghi sổ tức thì — không cần đối soát sau; 6 Báo cáo và dự báo — agent tài chính đọc thời gian thực" width="1671" height="941" loading="lazy" decoding="async" style="display:block;width:100%;height:auto;aspect-ratio:1671/941;background:#0f0e0d">',
     '<img src="assets/img/lattice-so-cai-en-v2.jpg" alt="Closed financial loop around one ledger for both AI and humans: 1 Revenue — income to the company wallet; 2 Auto allocation — smart contracts split funds; 3 Spend within limits — agent spends per policy; 4 Approval gate — a human signs above the threshold; 5 Instant booking — no reconciliation later; 6 Reporting and forecasting — finance agent reads in real time" width="1672" height="941" loading="lazy" decoding="async" style="display:block;width:100%;height:auto;aspect-ratio:1672/941;background:#0f0e0d">'),
